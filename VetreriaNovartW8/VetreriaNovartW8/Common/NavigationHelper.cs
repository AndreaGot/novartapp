...
namespace VetreriaNovartW8.Common
{
    /// <summary>
    /// NavigationManager favorisce la navigazione tra le pagine.  Fornisce i comandi utilizzati per 
    /// spostarsi avanti e indietro nonché esegue la registrazione delle scelte rapide standard da tastiera e con il mouse 
    /// utilizzate per spostarsi avanti e indietro.  Inoltre integra SuspensionManger
    /// per gestire la gestione del ciclo di vita dei processi e dello stato durante la navigazione tra le
    /// pagine.
    /// </summary>
    /// <example>
    /// Per utilizzare NavigationManager, seguire i due passaggi seguenti o
    /// iniziare con un elemento BasicPage o un altro modello di elemento per la pagina diverso da BlankPage.
    /// 
    /// 1) Creare un'istanza di NaivgationHelper in qualsiasi punto, ad esempio nel 
    ...
    /// </code>
    /// 
    /// 2) Registrare la pagina per chiamare un elemento di NavigationManager ogni volta che la pagina partecipa 
