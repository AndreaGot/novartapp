...
namespace VetreriaNovartW8
{
    ...
    /// </summary>
    public sealed partial class Contattaci : Page
    {
        ...
        async void DefaultLaunch(string link)
        {
        ...
        private  void btnInvia_Click(object sender, RoutedEventArgs e)
        {
           ...
           string subject = "Richiesta Informazioni - W8";
            string body = txtNome.Text + " scrive: \n" + txtRichiesta.Text;
            string link = string.Format("mailto:vetrerianovart@alice.it?subject={1}&body={2}", "", subject, body);
            //bool x = Launcher.LaunchUriAsync(new Uri(link, UriKind.Absolute));
            DefaultLaunch(link);
